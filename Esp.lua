        ...
        connection = game:GetService("RunService").RenderStepped:Connect(function()
            if v.Character ~= nil and v.Character:FindFirstChild("HumanoidRootPart") ~= nil and v.Name ~= plr.Name and v.Character.Humanoid.Health > 0 then 
                ...
                if OnScreen then
                    ...
                    local Size = Vector3.new(1.8, 2.3, 0) * (Scale * 2)
                    ...
                    NameTag.Position = Vector2.new(humpos.X, humpos.Y - 20)

                    if v.TeamColor == plr.TeamColor then
                        Top.Color = Color3.fromRGB(0, 0, 100)
                        Left.Color = Color3.fromRGB(0, 0, 100)
                        Bottom.Color = Color3.fromRGB(0, 0, 100)
                        Right.Color = Color3.fromRGB(0, 0, 100)
                    else 
                        Top.Color = Color3.fromRGB(100, 0, 0)
                        Left.Color = Color3.fromRGB(100, 0, 0)
                        Bottom.Color = Color3.fromRGB(100, 0, 0)
                        Right.Color = Color3.fromRGB(100, 0, 0)
                    end
...
game.Players.PlayerAdded:Connect(function(newplr) --Parameter gets the new player that has been added
    ...
    local NameTag = Drawing.new("Text")
    NameTag.Visible = false
    NameTag.Text = newplr.Name -- Nome do novo jogador
    NameTag.Font = 2
    NameTag.FontSize = 18
        ...
        connection = game:GetService("RunService").RenderStepped:Connect(function()
            if newplr.Character ~= nil and newplr.Character:FindFirstChild("HumanoidRootPart") ~= nil and newplr.Name ~= plr.Name  and newplr.Character.Humanoid.Health > 0 then
                ...
                if OnScreen then
                    ...
                    -- Posicionando a tag de nome acima do square
                    NameTag.Position = Vector2.new((TL.X + TR.X) / 2, TL.Y - 20)
